...
namespace VoyagerWebApi.Contexts
{
    public class VoyagerContext : DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer("Server=tcp:voyagerserver.database.windows.net,1433;Initial Catalog=VoyagerDb; User ID=voyageradmin;Password=voyager123$;Encrypt=True;TrustServerCertificate=True;Connection Timeout=30;");
